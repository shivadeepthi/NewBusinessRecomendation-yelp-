        ...
        <div class="panel-body">
          ...
          <div class="row">    
            ...
            <div class="col-md-2 col-sm-3 text-center">
              <a class="story-title" href="#"><img alt="" src="images/LasVegasStrip.jpg" style="width:100px;height:100px" class="img-circle"></a>
            </div>
             <%String t ="Ahwatukee";%>
            <div class="col-md-10 col-sm-9">
              ...
              <div class="row">
                <div class="col-xs-9">
                  <h4><span class="label label-default">Arizona</span></h4><h4>
                  <small style="font-family:courier,'new courier';" class="text-muted">Check recommendations <a href="RatingDistributionCityServlet?city_name=<%=t%>" class="text-muted">Read More</a></small>
                  </h4></div>
          ...
          <div class="row">    
            <br>
            <div class="col-md-2 col-sm-3 text-center">
              <a class="story-title" href="#"><img alt="" src="images/madisonwi.jpg" style="width:100px;height:100px" class="img-circle"></a>
            </div>
             <%String t1 ="Madison";%>
            <div class="col-md-10 col-sm-9">
              <h3>Madison</h3>
              <div class="row">
                <div class="col-xs-9">
                  <h4><span class="label label-default">Wisconsin</span></h4><h4>
                  <small style="font-family:courier,'new courier';" class="text-muted">Check recommendations<a href="RatingDistributionCityServlet?city_name=<%=t1%>" class="text-muted">Read More</a></small>
                  </h4></div>
                <div class="col-xs-3"></div>
              </div>
              <br><br>
          ...
          <div class="row">    
            <br>
            <div class="col-md-2 col-sm-3 text-center">
              <a class="story-title" href="#"><img alt="" src="images/phoenix.jpg" style="width:100px;height:100px" class="img-circle"></a>
            </div>
            <%String t2 ="Phoenix";%>
            <div class="col-md-10 col-sm-9">
              <h3>Phoenix</h3>
              <div class="row">
                <div class="col-xs-9">
                  <h4><span class="label label-default">Arizona</span></h4><h4>
                  <small style="font-family:courier,'new courier';" class="text-muted">Check recommendations<a href="RatingDistributionCityServlet?city_name=<%=t2%>" class="text-muted">Read More</a></small>
                  </h4></div>
                <div class="col-xs-3"></div>
              </div>
              <br><br>
